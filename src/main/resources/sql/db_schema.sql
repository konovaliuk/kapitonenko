...
ALTER TABLE `z_reports`
  ...
  ON DELETE NO ACTION
  ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_z_report_receipt` FOREIGN KEY (`last_receipt_id`) REFERENCES `receipts` (`id`)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION;

ALTER TABLE `z_report_details`
  ADD CONSTRAINT `FK_details_z_report` FOREIGN KEY (`z_report_id`) REFERENCES `z_reports` (`id`)
  ON DELETE CASCADE
  ON UPDATE NO ACTION;
